...
class AttendanceDialogs {
  static showAttendancePopup(BuildContext context, DateTime selectedStartDate, DateTime selectedEndDate) async {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  AttendanceReportItem(title: "Working Days", value: "${summaryData['working_days']} Days", dotColor: Colors.green),
                  const Divider(color: Colors.grey, thickness: 0.5),
                  AttendanceReportItem(title: "Late Hours", value: "${summaryData['late_hours']} min", dotColor: Colors.red),
                  const Divider(color: Colors.grey, thickness: 0.5),
                  AttendanceReportItem(title: "Absent", value: "${summaryData['absent_days']} Days", dotColor: Colors.black),
                  const Divider(color: Colors.grey, thickness: 0.5),
                  AttendanceReportItem(title: "Sick Leave", value: "${summaryData['sick_leaves']} Days", dotColor: Colors.orange),
                  const Divider(color: Colors.grey, thickness: 0.5),
                  AttendanceReportItem(title: "Annual Leave", value: "${summaryData['annual_leaves']} Days", dotColor: Colors.blue),
                  const Divider(color: Colors.grey, thickness: 0.5),
                  Align(
