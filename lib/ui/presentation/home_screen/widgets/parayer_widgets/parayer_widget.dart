                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              InkWell(
                                ...
                                child: isSoundMuted?
                                Icon(Icons.volume_mute, color: Colors.white, size: 30.w) :
                          ...
                          Stack(children: [
                            ...
                            Positioned(
                                ...
                                left: 0,
                                child:
                                    LabelWidget(name: translate('home.Fajr'), time: _fmt(pt?.fajr ?? DateTime.now()))),
                            Positioned(
                                bottom: 24.w,
                                left: 26.w,
                            ...
                            Positioned(
                                ...
                                left: 60.w,
                                child: LabelWidget(
                                    name: translate('home.Dhuhr'), time: _fmt(pt?.dhuhr ?? DateTime.now()))),
                            Positioned(
                                bottom: 70.w,
                                right: 0.w,
                                left: 0.w,
                            ...
                            Positioned(
                                ...
                                right: 50.w,
                                child: LabelWidget(
                                    name: translate('home.Maghrib'), time: _fmt(pt?.maghrib ?? DateTime.now()))),
                            Positioned(
                                bottom: 65.w,
                                right: 0,
                                child:
                                    LabelWidget(name: translate('home.Isha'), time: _fmt(pt?.isha ?? DateTime.now()))),
                            Positioned(
                                bottom: 28.w,
                                right: 25.w,
